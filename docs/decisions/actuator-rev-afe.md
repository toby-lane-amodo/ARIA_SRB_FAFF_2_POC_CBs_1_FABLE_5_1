...
`docs/DECISIONS.md` and the then-committed review PDF were deliberately
left alone — §8 lists what should be folded into them. (That PDF no longer
exists: `DEC-0028`.)
...
* **`TEST_PLAN.md`** — §4 asks `loadcell_afe` for "SPI3 hooks" and
  ...
  candidate of §7.
* **The review PDF** — deliberately not regenerated by this pass. Overtaken by
